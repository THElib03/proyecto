...
const MyTickets = () => {
  ...
  const fetchTickets = async () => {
    ...
    try {
      ...
      // setTickets(data)
      setTickets([
        { id: 1, route: 'New York → Boston', departure: '2024-03-15 08:00', seat: '12A', status: 'active', price: '$45' },
        { id: 2, route: 'Boston → Philadelphia', departure: '2024-03-20 14:30', seat: '5B', status: 'active', price: '$65' },
        { id: 3, route: 'New York → Boston', departure: '2024-02-28 08:00', seat: '8C', status: 'completed', price: '$45' },
      ])
    } catch (err) {
    ...
    <div className="app-container">
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p>You haven't booked any tickets yet. Start your journey today!</p>
        </div>
      ) : (
              ...
              <div className="card-footer">
                <div className="btn-group flex-col">
                  ...
                  {ticket.status === 'active' && (
                    <button className="btn btn-sm btn-danger" onClick={() => handleCancelTicket(ticket.id)}>
                      Cancel
                    </button>
                  )}
                </div>
